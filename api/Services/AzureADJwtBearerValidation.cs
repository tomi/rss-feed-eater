...
namespace RssFeedEater.Services
{
  public class AzureADJwtBearerValidation
  {
    ...
    private string _adPolicyName = string.Empty;
    private string _audience = string.Empty;
    private string _instance = string.Empty;
    private string _requiredScope = "demo.read";
    ...
    public AzureADJwtBearerValidation(IConfiguration configuration, ILoggerFactory loggerFactory)
    {
      ...
      _adPolicyName = _configuration["AZURE_AD_POLICY"];
      _audience = _configuration["AZURE_AD_CLIENT_ID"];
      _instance = _configuration["AZURE_AD_INSTANCE"];
      _wellKnownEndpoint = $"{_instance}{_adPolicyName}/v2.0/.well-known/openid-configuration";
    }
    ...
    {
      return _claimsPrincipal.Claims.FirstOrDefault(t => t.Type == "name")?.Value ?? String.Empty;
    }
